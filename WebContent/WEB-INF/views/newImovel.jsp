				...
				<div class="col-md-12 mb-3">
					<form method="POST" id="cadastrarImovel" action="doNewImovel">
						...
						<div class="form-group">
							<label for="tipoImovel">Tipo de Imóvel</label> <select
								name="tipoImovel" class="form-control" id="tipoImovel">
						...
						<div class="form-row">
							<div class="form-group col-md-3">
								<label for="quartos">Quartos</label> <input type="number"
									name="quartos" class="form-control" id="quartos" value="0"
									required />
							</div>
							<div class="form-group col-md-3">
								<label for="banheiros">Banheiros</label> <input type="number"
									name="banheiros" class="form-control" id="banheiros" value="0"
									required />
							</div>
							<div class="form-group col-md-3">
								<label for="suites">Suítes</label> <input type="number"
									name="suites" class="form-control" id="suites" value="0"
									required />
							</div>
							<div class="form-group col-md-3">
								<label for="vagasGaragem">Vagas na garagem</label> <input
									type="number" name="vagasGaragem" class="form-control"
									id="vagasGaragem" value="0" required>
							</div>
						</div>

						<div class="form-row">
							<div class="form-group col-md-4">
								<label for="areaConstruida">Área construída (m²)</label> <input
									type="number" name="areaConstruida" class="form-control"
									id="areaConstruida" value="0.0" required />
							</div>
							<div class="form-group col-md-4">
								<label for="areaTotal">Área total (m²)</label> <input
									type="number" name="areaTotal" class="form-control"
									id="areaTotal" value="0.0" required />
							</div>
						</div>
						...
						<div class="form-row">
							<div id="fotos" class="form-group col-md-12">
								...
								<div id="inputFoto" class="input-group mb-3">
									<input onfocusout="checkURL(this)" class="form-control"
										name="fotos" type="url"
										placeholder="http://exemplo.com.br - Informe URL válido de uma imagem"
										required />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								<label for="tipoNegocio">Tipo de Negócio</label> <select
									name="tipoNegocio" class="form-control" id="tipoNegocio">
									<option value="" selected>Selecione</option>
						...
						<div id="Imovel" style="display: none;" class="px-0 col-md-12">
							...
							<hr>
							<div id="ImovelApartamento" style="display: none;"
								class="px-0 col-md-12">
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="bloco">Bloco</label> <input type="text"
											name="bloco" class="form-control" id="bloco" />
									</div>
									<div class="form-group col-md-3">
										<label for="andar">Andar</label> <input type="number"
											name="andar" class="form-control" id="andar" />
									</div>
									<div class="form-group col-md-3">
										<label for="numeroAp">Número do AP</label> <input
											type="number" name="numeroAp" class="form-control"
											id="numeroAp" />
									</div>
									<div class="form-group col-md-2">
										<div class="form-check">
											<input type="checkbox" name="sacada" class="form-check-input"
												id="sacada" /> <label for="sacada" class="form-check-label">Sacada</label>
										</div>
									</div>
								</div>
							</div>
							<div id="ImovelCasa" style="display: none;"
								class="px-0 col-md-12">
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="lote">Lote</label> <input type="text" name="lote"
											class="form-control" id="lote" />
									</div>
									<div class="form-group col-md-4">
										<label for="quadra">Quadra</label> <input type="text"
											name="quadra" class="form-control" id="quadra" />
									</div>
								</div>
							</div>
						</div>
						...
						<div id="Negocio" style="display: none;" class="px-0 col-md-12">
							...
							<hr>
							<div id="NegocioLocacao" style="display: none;"
								class="px-0 col-md-12">
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="dataLocacaoInicio">Data de Início</label> <input
											type="date" name="dataLocacaoInicio" class="form-control"
											id="dataLocacaoInicio" />
									</div>
									<div class="form-group col-md-4">
										<label for="dataLocacaoFim">Data de Fim</label> <input
											type="date" name="dataLocacaoFim" class="form-control"
											id="dataLocacaoFim" />
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="valorMensal">Valor mensal</label> <input
											type="number" name="valorMensal" class="form-control"
											id="valorMensal" />
									</div>
									<div class="form-group col-md-4">
										<label for="valorAnual">Valor anual</label> <input
											type="number" name="valorAnual" class="form-control"
											id="valorAnual" />
									</div>
									<div class="form-group col-md-4">
										<label for="formaPagamentoLocacao">Forma de pagamento</label>
										<input type="text" name="formaPagamentoLocacao"
											class="form-control" id="formaPagamentoLocacao" />
									</div>
								</div>
							</div>
							<div id="NegocioVenda" style="display: none;"
								class="px-0 col-md-12">
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="dataVendaIniciada">Data de Início da venda</label>
										<input type="date" name="dataVendaIniciada"
											class="form-control" id="dataVendaIniciada" />
									</div>
									<div class="form-group col-md-4">
										<label for="dataVendaFinalizada">Data de Fim da venda</label>
										<input type="date" name="dataVendaFinalizada"
											class="form-control" id="dataVendaFinalizada" />
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="valorVenda">Valor de venda</label> <input
											type="number" name="valorVenda" class="form-control"
											id="valorVenda" />
									</div>
									<div class="form-group col-md-4">
										<label for="formaPagamentoVenda">Forma de pagamento</label> <input
											type="text" name="formaPagamentoVenda" class="form-control"
