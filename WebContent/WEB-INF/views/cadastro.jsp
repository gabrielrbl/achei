      ...
      <div id="login">
        ...
        <form method="post" action="doLogin"> 
	 	...
	 	<p class="link">
            ...
            <a href="${pageContext.request.contextPath}/Achei/WebContent/WEB-INF/views/cadastro.jsp">Cadastre-se</a>
          </p>
	 	</div>
        </form>
      </div>
