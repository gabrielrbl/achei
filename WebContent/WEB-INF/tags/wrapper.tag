...
.notification .dropdown-toggle::after, .connection .dropdown-toggle::after,
...
<body>
	<nav class="navbar navbar-expand-lg bg-white fixed-top">
		...
		<div class="collapse navbar-collapse " id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto navbar-right-top">
				<li class="nav-item dropdown nav-user"><a class="nav-link"
							...
							<li class="connection-list">
								<div class="row">
									<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
										<a href="${pageContext.request.contextPath}/userImoveis"
											class="connection-item"> <img
											src="https://img.icons8.com/color/100/000000/real-estate.png"
											alt=""> <span>Imóveis</span>
										</a>
									</div>
								</div>
							</li>
					...
					<div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
						...
						<div class="nav-user-info">
							<h5 class="mb-0 text-white nav-user-name"
								...
								<c:out
									value="${empty usuarioLogado ? 'Visitante' : fn:toLowerCase(usuarioLogado.nome)}" />
							</h5>
							<c:if test="${!empty usuarioLogado}">
								<span class="status"></span>
								<span class="ml-2"><c:out
										value="${usuarioLogado.ativo == true ? 'Ativo' : 'Inativo'}" /></span>
							</c:if>
						</div>
						...
						<c:choose>
							<c:when test="${!empty usuarioLogado}">
								...
								<a class="dropdown-item"
									...
									class="fas fa-power-off mr-2"></i>Sair</a>
							</c:when>
							<c:otherwise>
								<a class="dropdown-item"
									href="${pageContext.request.contextPath}/login"><i
									class="fas fa-user mr-2"></i>Entrar</a>
							</c:otherwise>
						</c:choose>
					</div></li>
			</ul>
	...
	<footer class="fixed-bottom">
		<div class="col-md-12 p-1 text-center">&copy; Copyright 2021 -
			Achei!</div>
	</footer>
</body>
</html>